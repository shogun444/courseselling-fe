...
export default function ImageScroll() {
  ...
  const translateText = useTransform(scrollYProgress, [0, 1], [-400, 500]);
  const translateImage = useTransform(scrollYProgress, [0, 1], [400, -500]);
  return (
    <div ref={ref} className="flex-col justify-end  mx-auto md:w-2/4 relative ">
      <motion.div
        style={{
          y: translateText,
        }}
      ...
      <div ref={ref} className="relative w-[2/4] mx-auto h-71">
        <motion.div
          style={{
            y: translateImage,
          }}
          className=" absolute translate-y-100 p-2 bg-white  mx-auto rounded-t-3xl h-71 w-250 -translate-x-35"
        >
          <div className=" p-6 bg-[#f7f3fc]    mx-auto rounded-t-xl relative h-63">
            <div className=" bg-white  mx-auto rounded-t-md relative h-59">
              <Image
                className="absolute  mask-b-from-65% h-176  inset-0 rounded-lg p-0.5   "
                height={2000}
                width={2000}
                alt="hero"
                src={"/hero.avif"}
