...
export default function SVG(){
  return(<div className="max-w-70 mx-auto">
   {/* <h1>Signup</h1>
  ...
  <svg className="-translate-y-74" xmlns="http://www.w3.org/2000/svg" width="70%" height="50%" viewBox="0 0 242 364">
  ...
  d="M 48 1.5 L 48 84 C 48 92.837 55.163 100 64 100 L 225 100 C 233.837 100 241 107.163 241 116 L 241 161 C 241 169.837 233.837 177 225 177 L 214.5 177 L 214.5 208 L 214.5 177 L 17 177 C 8.163 177 1 184.163 1 193 L 1 363" stroke="rgb(177, 161, 192)" strokeWidth="2" strokeLinejoin="round" fill="transparent" opacity="1" pathLength="1" strokeDashoffset="0px" strokeDasharray="1px 1px" will-change="auto"></motion.path></svg>
  </div>)
}